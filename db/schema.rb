...
ActiveRecord::Schema[7.0].define(version: 2023_03_18_161602) do
  create_table "certification_types", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
  end

  create_table "certifications", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "charge_types", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
  ...
  create_table "charges", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "checkouts", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "tool_id"
  ...
  create_table "event_types", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.boolean "display"
    t.string "name"
  end
  ...
  create_table "faqs", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    ...
    t.index ["organization_category_id"], name: "index_faqs_on_organization_category_id"
  end
  ...
  create_table "organization_aliases", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.integer "organization_id"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
  ...
  create_table "organization_categories", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
    t.boolean "building"
  ...
  create_table "organization_status_types", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.boolean "display"
  end

  create_table "organization_timeline_entries", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "organization_timeline_entry_types", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
  end
  ...
  create_table "participants", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "eppn"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
  ...
  create_table "shift_participants", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "shift_id"
    t.integer "participant_id"
  ...
  create_table "shift_types", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
    t.string "short_name"
  ...
  create_table "shifts", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "store_items", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
  ...
  create_table "store_purchases", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "charge_id"
  ...
  create_table "tool_type_certifications", id: :integer, charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "tool_types", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
  end

  create_table "tools", id: :integer, charset: "utf8mb3", force: :cascade do |t|
    t.integer "barcode"
    t.text "description"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
